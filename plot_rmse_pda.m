function plot_rmse_pda(parameter,rmse_1_position,rmse_1_velocity,N_k_1,rmse_2_position,rmse_2_velocity,N_k_2)
...
figure;
plot(r_1_pos);
title('RMSE of target 1 position (Probabilistic Data Association)');
xlabel('Time K');
...
figure;
plot(r_1_vel);
title('RMSE of target 1 velocity (Probabilistic Data Association)');
xlabel('Time K');
...
figure;
plot(r_2_pos);
title('RMSE of target 2 position (Probabilistic Data Association)');
xlabel('Time K');
...
figure;
plot(r_2_vel);
title('RMSE of target 2 velocity (Probabilistic Data Association)');
xlabel('Time K');
