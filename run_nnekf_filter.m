function est = run_NNEKF_filter(parameter,meas)
...
%            est.tracker = tracker;
       ...
       [z_valid,z_unvalid,valid_idx_x,unvalid_idx_x]= gate_meas_nnekf(meas.Z{k},gate,parameter,est.P{k},est.x{k});       
       
       %%%%%update
       [P_update, x_update, q_update, z_unvalid]= ekf_update_nnekf(meas.Z{k},parameter,est.P{k},est.x{k},est.q{k},z_valid,z_unvalid,valid_idx_x,unvalid_idx_x);
       ...
       %%%%%delete tentative and add life here
